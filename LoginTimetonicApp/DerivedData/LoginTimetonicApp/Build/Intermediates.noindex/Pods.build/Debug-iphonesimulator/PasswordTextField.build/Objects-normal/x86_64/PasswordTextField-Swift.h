...
#ifndef PASSWORDTEXTFIELD_SWIFT_H
#define PASSWORDTEXTFIELD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PasswordTextField",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull imageTintColor;
/// The image to show the secure text
@property (nonatomic, strong) IBInspectable UIImage * _Nullable customShowSecureTextImage;
/// The image to hide the secure text
@property (nonatomic, strong) IBInspectable UIImage * _Nullable customHideSecureTextImage;
