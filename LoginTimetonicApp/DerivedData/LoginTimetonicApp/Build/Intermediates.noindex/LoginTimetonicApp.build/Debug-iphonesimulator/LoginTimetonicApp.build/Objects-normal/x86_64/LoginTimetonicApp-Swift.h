...
#ifndef LOGINTIMETONICAPP_SWIFT_H
#define LOGINTIMETONICAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LoginTimetonicApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17LoginTimetonicApp11AppDelegate")
...
SWIFT_CLASS("_TtC17LoginTimetonicApp19LogInViewController")
@interface LogInViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified emailTextfield;
@property (nonatomic, weak) IBOutlet PasswordTextField * _Null_unspecified passwordTextfield;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC17LoginTimetonicApp13SceneDelegate")
